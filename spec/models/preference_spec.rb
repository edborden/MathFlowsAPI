describe Preference do
  ...
  describe "db" do
    ...
    it { should have_db_column(:group_help).of_type(:boolean).with_options default:true,null:false }
    it { should have_db_column(:me_group_help).of_type(:boolean).with_options default:true,null:false }
    it { should have_db_column(:me_test_help).of_type(:boolean).with_options default:true,null:false }
