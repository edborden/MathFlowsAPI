...
ActiveRecord::Schema.define(version: 20151021153328) do
  ...
  add_index "alignments", ["alignable_type", "alignable_id"], name: "index_alignments_on_alignable_type", unique: true, using: :btree
  ...
  add_index "google_auths", ["google_id"], name: "index_google_auths_on_google_id", unique: true, using: :btree
  add_index "google_auths", ["user_id"], name: "index_google_auths_on_user_id", unique: true, using: :btree
  ...
  create_table "groupvitations", force: :cascade do |t|
  ...
  add_index "invitations", ["referral_email"], name: "index_invitations_on_referral_email", unique: true, using: :btree
  add_index "invitations", ["referral_id"], name: "index_invitations_on_referral_id", unique: true, using: :btree
  ...
  add_index "plans", ["user_id"], name: "index_plans_on_user_id", unique: true, using: :btree
  ...
  create_table "preferences", force: :cascade do |t|
    ...
    t.boolean  "me_group_help",   default: true, null: false
    t.boolean  "me_test_help",    default: true, null: false
  end
  ...
  create_table "projections", force: :cascade do |t|
    t.integer "table_id",               null: false
    t.integer "axis",     default: 0,   null: false
    t.float   "position", default: 1.0, null: false
    t.integer "size"
  end
