class UserSerializer < ApplicationSerializer
  attributes :guest,:name,:pic,:email,:created_at,:uservoice_token,:tests_count,:tests_quota,:referred_by,:invitation_id,:google_referrer,:facebook_referrer,:kickstarter_referrer
